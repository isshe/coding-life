...
static void square_prog_1(struct svc_req *rqstp, SVCXPRT *transp);

static void
square_prog_1(struct svc_req *rqstp, SVCXPRT *transp)
{
	union {
	...
	case SQUAREPROC:
		xdr_argument = (xdrproc_t) xdr_square_in;
		xdr_result = (xdrproc_t) xdr_square_out;
...
main( int argc, char* argv[] )
{
	...
	if (getsockname(0, (struct sockaddr *)&saddr, &asize) == 0) {
		...
		_rpcpmstart = 1;
		proto = 0;
		openlog("1_1_ex_square", LOG_PID, LOG_DAEMON);
	} else {
#ifndef RPC_SVC_FG
		int size;
		int pid, i;
